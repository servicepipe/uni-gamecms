...
CREATE TABLE IF NOT EXISTS `config__secondary` (
  ...
  `version` varchar(10) NOT NULL DEFAULT '5.7.7',
...
(1, 2, NULL, NULL, NULL, 2, NULL, 2, NULL, NULL, 120, 1634158027, 2, '', 30, 30, 12, 30, 10, 30, 30, 2, 0, '5.7.7', 30, '1', 'Ведутся технические работы', '', 2, 2, 10, 2, 2, 1);
