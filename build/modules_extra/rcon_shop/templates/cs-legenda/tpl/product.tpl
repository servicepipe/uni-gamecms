    ...
    <div class="block rcon-shop-product-in-detail">
       <div class="block_head">
            ...
            <div {if('{isHasTarifs}' == '2')} style="display: none" {/if}>
                ...
                <div class="row" data-toggle="buttons">
                    {for($l = 0; $l < count($tarifs); $l++)}
                        <div class="btn-group-toggle mb-3 col-lg-{if(count($params) % 4 == 0)}3{else}{if(count($params) % 3 == 0)}4{else}{if(count($params) % 2 == 0)}6{else}4{/if}{/if}{/if}">
                            <label
        ...
        {if(is_auth())}
            ...
            <button id="buy-btn" class="btn btn-primary disabled mt-2">Оплатить</button>

            <div id="success-result" class="noty-block success" style="display: none">
