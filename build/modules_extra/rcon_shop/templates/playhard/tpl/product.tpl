<div class="col-lg-9 order-is-first">
    <div class="block rcon-shop-product-in-detail">
       <div class="block_head mb-3">
            ...
            <div {if('{isHasTarifs}' == '2')} style="display: none" {/if}>
                ...
                <div class="row" data-toggle="buttons">
                    {for($l = 0; $l < count($tarifs); $l++)}
                        <div class="btn-group-toggle mb-2 col-lg-{if(count($params) % 4 == 0)}3{else}{if(count($params) % 3 == 0)}4{else}{if(count($params) % 2 == 0)}6{else}4{/if}{/if}{/if}">
                            <label
        ...
        {if(!empty($params))}
            ...
            <form class="row" id="params">
                {for($l = 0; $l < count($params); $l++)}
                    <div class="col-lg-{if(count($params) % 4 == 0)}3{else}{if(count($params) % 3 == 0)}4{else}{if(count($params) % 2 == 0)}6{else}12{/if}{/if}{/if}">
        ...
        {if(is_auth())}
            ...
            <div id="error-result" class="noty-block error mt-2" style="display: none"></div>

            <button id="buy-btn" class="btn btn-primary disabled mt-2 mb-0">Оплатить</button>

            <div id="success-result" class="noty-block success mb-0 mt-2" style="display: none">
