	...
	*/
	...
	if ($page->type == 2) {
		...
		if(empty($conf->copyright_key) || $conf->copyright_key != md5($host . "_uniCopyright")):
			/*
				Если вы хотите что бы проект существовал и развивался пожалуйста не убирайте копирайт.
				Чем больше людей узнает о проекте, тем больше желания у автора будет им заниматься, и наделять вас полезными дополнениями.
			*/
