<div class="central-block install-block">
	...
	<div class="central-block-body">
		...
		<input type="text" class="form-control mt-10" placeholder="Сервер MySQL" id="host" autocomplete="off" value="localhost">
		...
		<div>
			...
			<br>
			<input id="checbox" title="dont_agree" type="checkbox" onclick="on_install();"> Я ознакомлен и согласен с <a target="_blank" href="https://unigamecms.ru/license">пользовательским соглашением</a><br>
