<div class="col-lg-9 order-is-first">
	<div class="block">
		...
		<p>Выберите игрока или администратора, на которого вы хотите подать жалобу, подробно опишите жалобу, <font color="red"><b>обязательно</b></font> приложите в качестве доказательств скриншоты и демо запись</p>
		<br>
		<center>Обратите пожалуйста внимание, заявки без <font color="yellow"><b>демо</b></font> не подлежат рассмотрению</center>
	</div>
