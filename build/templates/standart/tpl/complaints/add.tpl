<div class="col-lg-9 order-is-first">
	<div class="block">
		...
		<p>Выберите администратора, на которого вы хотите подать жалобу, подробно опишите жалобу, <font color="red"><b>обязательно</b></font> приложите в качестве доказательств скриншоты и демо запись</p>
		<br>
